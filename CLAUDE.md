...
- **BuddyAccessibilityService** (`service/`) — reads accessibility node tree, executes taps/swipes/typing via gesture API
- **BuddyListenerService** (`service/`) — foreground service for wake word detection + speech recognition
...
└── ui/
    ...
    └── components/ # BuddyOrb animated indicator
```
